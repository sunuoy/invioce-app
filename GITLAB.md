...
curl --header "PRIVATE-TOKEN: YOUR_PERSONAL_ACCESS_TOKEN" \
     ...
     "https://gitlab.com/api/v4/projects/YOUR_PROJECT_ID/packages/generic/invoice-generator/1.6/InvoiceGenerator_v1.6_debug.apk"
```
...
$uri = "https://gitlab.com/api/v4/projects/$projectId/packages/generic/invoice-generator/1.6/InvoiceGenerator_v1.6_debug.apk"
